$(document).ready(function () {
    ...
    (function ($) {
        ...
        var allMise = [
            ...
            mise_red = new CaseMise("Red", "Red", 2),
            mise_black = new CaseMise("Black", "Black", 2),
            mise_even = new CaseMise("Even", "Even", 2),
            mise_odd = new CaseMise("Odd", "Odd", 2)]
        ...
        $(".case,.casemise,.casemisebis").click(function () {
            ...
            if (thunesJoueurs - valeurmisejeton >= 0) {
                if (verifDoubleMise(omc.valeur)) {
                    listeMise.push(omc.valeur); // omc.valeur
            ...
            alert("Tu n'as plus d'argent à miser...")
            }
        ...
        function verifMiseetGains(listeMise, rdCaseChoice ) {
            ...
            for (j = 0; j < listeMise.length; j++) {
                alert(listeMise[j])
                if(listeMise[j] == "1st_12" || listeMise[j] == "2nd_12" || listeMise[j] == "3rd_12" || listeMise[j] == "1-18" || listeMise[j] == "19-36"){
                    listeMise[j] 
                }
            }
                ...
                /*for (i = 0; i < chiffremise.length; i++) {
                    misegain = parseInt(document.querySelector('.conteurmise' + listeMise[i]).textContent);
                    if (listeMise[j] == chiffremise[i] && listeMise[j] == "Even") {
