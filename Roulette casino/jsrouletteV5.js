$(document).ready(function () {
    ...
    (function ($) {
        ...
        case_1 = new CaseNum(1, "Red", "Odd", 1, 1),
        case_2 = new CaseNum(2, "Black", "Even", 1, 1),
        case_3 = new CaseNum(3, "Red", "Odd", 1, 1),
        case_4 = new CaseNum(4, "Black", "Even", 1, 1),
        case_5 = new CaseNum(5, "Red", "Odd", 1, 1),
        case_6 = new CaseNum(6, "Black", "Even", 1, 1),
        case_7 = new CaseNum(7, "Red", "Odd", 1, 1),
        case_8 = new CaseNum(8, "Black", "Even", 1, 1),
        case_9 = new CaseNum(9, "Red", "Odd", 1, 1),
        case_10 = new CaseNum(10, "Black", "Even", 1, 1),
        case_11 = new CaseNum(11, "Black", "Odd", 1, 1),
        case_12 = new CaseNum(12, "Red", "Even", 1, 1),
        case_13 = new CaseNum(13, "Black", "Odd", 2, 1),
        case_14 = new CaseNum(14, "Red", "Even", 2, 1),
        case_15 = new CaseNum(15, "Black", "Odd", 2, 1),
        case_16 = new CaseNum(16, "Red", "Even", 2, 1),
        case_17 = new CaseNum(17, "Black", "Odd", 2, 1),
        case_18 = new CaseNum(18, "Red", "Even", 2, 1),
        case_19 = new CaseNum(19, "Red", "Odd", 2, 2),
        case_20 = new CaseNum(20, "Black", "Even", 2, 2),
        case_21 = new CaseNum(21, "Red", "Odd", 2, 2),
        case_22 = new CaseNum(22, "Black", "Even", 2, 2),
        case_23 = new CaseNum(23, "Red", "Odd", 2, 2),
        case_24 = new CaseNum(24, "Black", "Even", 2, 2),
        case_25 = new CaseNum(25, "Red", "Odd", 3, 2),
        case_26 = new CaseNum(26, "Black", "Even", 3, 2),
        case_27 = new CaseNum(27, "Red", "Odd", 3, 2),
        case_28 = new CaseNum(28, "Black", "Even", 3, 2),
        case_29 = new CaseNum(29, "Black", "Odd", 3, 2),
        case_30 = new CaseNum(30, "Red", "Even", 3, 2),
        case_31 = new CaseNum(31, "Black", "Odd", 3, 2),
        case_32 = new CaseNum(32, "Red", "Even", 3, 2),
        case_33 = new CaseNum(33, "Black", "Odd", 3, 2),
        case_34 = new CaseNum(34, "Red", "Even", 3, 2),
        case_35 = new CaseNum(35, "Black", "Odd", 3, 2),
        case_36 = new CaseNum(36, "Red", "Even", 3, 2)]
        ...
        var allMise = [mise_1_12 = new CaseMise(3),
        mise_2_12 = new CaseMise(3),
        mise_1_18 = new CaseMise(3),
        mise_19_36 = new CaseMise(2),
        mise_red = new CaseMise(2),
        mise_black = new CaseMise(2),
        mise_even = new CaseMise(2),
        mise_odd = new CaseMise(2)]
        ...
        $(".case,.casemise,.casemisebis").click(function () {
            ...
            if (verifDoubleMise(valeur)) {
                $(".recapMise").append("<div class='miseencours'><h3>" + valeur + "</h3><div class='conteurmise" + valeur + "'>" + valeurmisejeton + "</div><button class='suppr" + valeur + "'>X</button></div>")

            } else {
                // fait augmenter si deja dans la liste
                duaphin = document.querySelector('.conteurmise' + valeur);
                compteur = parseInt(duaphin.textContent);
                compteur = compteur + valeurmisejeton;
                $('.conteurmise' + valeur).html(compteur);
            }
            ...
            $('.suppr' + valeur).on("click", function () {
                ...
                enleveListValeur(listeMise, valeur);
            })
        })
        ...
        function verifDoubleMise(valeur) {
            ...
            for (i = 0; i < listeMise.length; i++) {
                if (listeMise[i] === valeur) {
                    c = false;
                }
            }
            listeMise.push(valeur);
            return c;
        }
        ...
        var frequence = [];
        $(".spin").click(function () {
            caseChoice = choiceNum(allCase);
            //  alert(nombreRD);
            //  alert(listeMise);
            //   verifMiseencours(nombreRD,listeMise);

            frequence.push(caseChoice)

            frequenceNb(frequence);

            $(".histor").prepend("<div class='histo'><h3>" + caseChoice.valeur + "</h3></div>")
            if (voir == false) {
                $(".histo").css("visibility", "visible")
            }
          ...
          //  $(".recapMise").innerHTML("<div class='recapMise'><h3 class='titremise'>Mise en cours</h3></div>")
        })
        ...
        function verifMiseencours(chiffremise, listedeMise) {

            for (j = 0; j < listedeMise.length; j++) {
                for (i = 0; i < chiffremise.length; i++) {
                    misegain = parseInt(document.querySelector('.conteurmise' + listedeMise[i]).textContent);
                    if (listedeMise[j] == chiffremise[i] && listedeMise[j] == "Even") {
                        alert("bien joué bg de la street")
                        alert("mise gain = " + misegain)
                        thunesJoueurs = thunesJoueurs + misegain;
                    }
                }
